...
\begin{enumerate}
    \item {\hl{Embedded} %MDPI: Please confirm if the bold formatting in the paper is necessary; if not, please remove it. 
...
\begin{figure}[H]
	...
	\caption{\hl{Raw} %MDPI: To reduce white space, we have not placed it where it is first mentioned, please confirm. #13
...
\setlength{\tabcolsep}{11.8mm}
 ...
 instability performance parameters.\protect\label{tab:-4}}
	...
	\begin{tabular}{ccc}
		\toprule
		Axis         & {VRW} {$\left[\si{\meter\per\second\per\sqrt{{\hour}}}\right]$} & {Bias Instability} {{$\left[\si{\milli\gravity}\right]$}} \\\midrule
		$\mathbf{x}$ & $\num{3.9594}$                                                    & $\num{0.5383}$                                 \\
		$\mathbf{y}$ & $\num{1.9444}$                                                    & $\num{1.1031}$                                 \\
		$\mathbf{z}$ & $\num{2.8702}$                                                    & $\num{1.8719}$                                 \\
		\bottomrule
...
\begin{tabular}{@{}l c c@{}}
\toprule
Performance Grade & {Bias Instability} & {Typical Application} \\ \midrule
...
{\hl{This Work} %MDPI: Please confirm if the bold formatting in the table is necessary; if not, please remove it. 
...
\noindent{\footnotesize{{\hl{Note:} %MDPI: Please confirm if the italics are necessary; if not, please remove them. 
...
\newblock In Proceedings of the Anais do Congresso Brasileiro de Autom{\'{a}}tica 2020.\hl{ sbabra,  dec 2020.} \textcolor{blue}{Porto Alegre, Brazil, 23--26 November 2020.} %MDPI: please replace them with conference address and date.
