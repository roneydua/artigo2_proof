...
\begin{enumerate}
    \item {\hl{Embedded} %MDPI: Please confirm if the bold formatting in the paper is necessary; if not, please remove it. Response: The bold formatting has been removed.  Response: The formatting is correct as is, since the term refers to the equation itself and is not a equation number.
...
\newblock In Proceedings of the Anais do Congresso Brasileiro de Autom{\'{a}}tica 2020.\hl{ sbabra,  dec 2020.} \textcolor{blue}{Porto Alegre, Brazil, 23--26 November 2020.} %MDPI: please replace them with conference address and date. Response: We have updated the conference location and dates (highlighted in blue) as requested.
